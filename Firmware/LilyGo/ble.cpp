...
void stopBLE() {
  ...
  NimBLEDevice::deinit(true);  // true = free memory
...
int bondBLE() {
  ...
  } else if (currentStatus == BOND_STATUS_CONNECTED) {
    // display.println("BLE Connected!");
  } else if (currentStatus == BOND_STATUS_BONDED) {
    // display.println("BLE Bonded!");
    bleBonded = true;
  } else if (currentStatus == BOND_STATUS_FAILED) {
    // display.println("BLE Bonding");
    // display.println("failed!");
  } else if (currentStatus == BOND_STATUS_DISCONNECTED) {
    // display.println("BLE Disconnected!");
  } else if (currentStatus == BOND_STATUS_GATTCONNECT) {
    // display.println("BLE GATT");
    // display.println("Connect!");
  } else if (currentStatus == BOND_STATUS_GATTDISCONNECT) {
    // display.println("BLE GATT");
    // display.println("Disconnected!");
  } else if (currentStatus == BOND_STATUS_SECURITYEVT) {
    // display.println("BLE Security");
    // display.println("Event!");
  } else if (currentStatus == BOND_STATUS_AUTHCOMPLETE) {
    // display.println("BLE Auth.");
    // display.println("Complete!");
  } else if (currentStatus == BOND_STATUS_UPDATECONNPARAMS) {
...
bool BLE_Bond::begin(const char* localName = "WatchyUnlock") {
  ...
  NimBLECharacteristic* pCharacteristic = pService->createCharacteristic(
    CHARACTERISTIC_UUID,
    NIMBLE_PROPERTY::READ | NIMBLE_PROPERTY::READ_ENC |  // Verschlüsselung triggern
