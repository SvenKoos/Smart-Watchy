...
public:
  otaCallback(BLE_OTA *ble) { _p_ble = ble; }
  BLE_OTA *_p_ble;
...
//
// begin
bool BLE_OTA::begin(const char *localName = "Watchy BLE OTA") {
...
int BLE_OTA::updateStatus() { return status; }

int BLE_OTA::howManyBytes() { return bytesReceived; }